    ...
    <OpenLayout>
      ...
      <main className="w-11/12 py-16 m-auto">
        ...
        <article className="prose prose-invert prose-headings:text-zinc-300 prose-strong:text-zinc-400 prose-blockquote:text-zinc-500 prose-p:text-zinc-500 prose-span:text-zinc-500 prose-ol:text-zinc-500 prose-ul:text-zinc-500 prose-li:text-zinc-500 prose-a:text-theme-accent/70 max-w-none">
          <h1 className="font-righteous font-semibold mt-10 text-5xl max-sm:text-3xl">Terms Of Service</h1>
          <blockquote className="-mt-6 text-sm sm:text-base font-normal">Last Updated: May 18nd, 2024</blockquote>
          <h2>Welcome to {title}</h2>
          <p>
            These terms of service outline the rules and regulations for the use of {title}'s Website. By accessing this
            website we assume you accept these terms of service in full. Do not continue to use {title}'s website if you
            do not accept all of the terms of service stated on this page. The following terminology applies to these
            Terms of Service, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", "You" and
            "Your" refers to you, the person accessing this website and accepting the Company's terms of service. "The
            Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to
            both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using {title}'s website you consent to the use of cookies in accordance
            with
            {title}'s privacy policy. Most of the modern day interactive web sites use cookies to enable us to retrieve
            user details for each visit. Cookies are used in some areas of our site to enable the functionality of this
            area and ease of use for those people visiting. Some of our affiliate / creation partners may also use
            cookies.
          </p>
          <h2>License</h2>
          <p>
            Unless otherwise stated, {title} and/or it's licensors own the intellectual property rights for all material
            on {title}. All intellectual property rights are reserved. You may view and/or print pages from {title} for
            your own personal use subject to restrictions set in these terms of service.
          </p>
          <strong>You must not:</strong>
          <ol>
            <li>Republish material from {title}</li>
            <li>Sell, rent or sub-license material from {title}</li>
            <li>Reproduce, duplicate or copy material from {title}</li>
          </ol>
          <p>Redistribute content from {title} (unless content is specifically made for redistribution).</p>
          <h2>User Comments</h2>
          <ol>
            <li>This Agreement shall begin on the date hereof.</li>
            <li>
              Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
              material and data ('Comments') in areas of the website. {title} does not screen, edit, publish or review
              Comments prior to their appearance on the website and Comments do not reflect the views or opinions of
              {title}, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view
              or opinion. To the extent permitted by applicable laws {title} shall not be responsible or liable for the
              Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any
              use of and/or posting of and/or appearance of the Comments on this website.
            </li>
            <li>
              {title} reserves the right to monitor all Comments and to remove any Comments which it considers in its
              absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms of Service.
            </li>
            <li>
            ...
            <li>
              You hereby grant to {title} a non-exclusive royalty-free license to use, reproduce, edit and authorize
          ...
          <ol>
            ...
            <li>
              ...
              <ol type="a">
                ...
                <li>
                  associations or other groups representing charities, including charity giving sites, online directory
                  distributors;
                </li>
          ...
          <p>
            ...
            to link); (b)the organization does not have an unsatisfactory record with us; (c) the benefit to us from the
            visibility associated with the hyperlink outweighs the absence of {title}; and (d) where the link is in the
          ...
          <p>
            ...
            . Please include username, your organization name, contact information (such as a phone number and/or e-mail
            address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site,
            and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response.
          </p>
          <strong>Approved organizations may hyperlink to our Web site as follows:</strong>
          <ol type="a">
          ...
          <p>
            No use of {title}'s logo or other artwork will be allowed for linking absent a trademark license agreement.
          </p>
          <h2>Iframes</h2>
          <p>
          ...
          <p>
            If you find any link on our Web site or any linked web site objectionable for any reason, you may contact us
